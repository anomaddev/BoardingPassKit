...
public struct BoardingPass: Codable {
    ...
    /// The BCBP format version number (single character from conditional items section)
    /// This indicates the version of the conditional items structure, typically "5", "6", or "7"
    /// Note: This is different from the IATA Implementation Guide version
